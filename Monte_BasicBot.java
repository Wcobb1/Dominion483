...
public class Monte_BasicBot extends Player {
	protected String firstCard;
	protected boolean firstCardBuy;
	
	public Monte_BasicBot(Kingdom k, PlayerCommunication pc){
		super(k, pc);
		this.firstCard = "NA";
		this.firstCardBuy = false;
	}

	public Monte_BasicBot(Kingdom k, PlayerCommunication pc, String c) {
		super(k, pc);
		this.firstCard = c;
